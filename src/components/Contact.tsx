    ...
    return (
        <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-y-0 lg:space-x-8' id='contact'>
            <div className='flex justify-center items-center'>
                <ul className='space-y-4'>
                    <li className='flex items-center'>
                        ...
                        <p className='text-xl'>06 18 18 83 16</p>
                    </li>
                    <li className='flex items-center'>
                        <Image src={mail} alt='mail' className='h-[110px] w-auto mr-6'/>
                        <p className='text-xl'>rparone2@gmail.com</p>
                    </li>
                </ul>
            </div>
            ...
            <div className='bg-white/10 p-6 rounded xl max-w-[550px]'>
                ...
                <p className='text-white/70 mb-6'>Send me a message and let's call.</p>
                <form className='space-y-4' action='https://getform.io/f/byvkqkwa' method='POST'>
                    ...
                    <button className='bg-orange-700 hover:bg-orange-500 text-white px-6 py-2 w-full font-semibold text-xl rounded-xl'>Send your message</button>
                </form>
            </div>
        </div>
    )
